...
Object.assign(labels.en, { howEyebrow: "Keep it simple", howTitle: "A break that fits inside a real workday.", howText: "No special equipment, no complicated routine. Just a little more care between the things you already need to do.", stepOneTitle: "Choose your reset", stepOneText: "Find an exercise for the part of your body that needs attention.", stepTwoTitle: "Follow the pace", stepTwoText: "Use the short instructions and move only within a comfortable range.", stepThreeTitle: "Return with intention", stepThreeText: "Notice how you feel, then come back to your work with a clearer head." });
